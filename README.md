...
## Usage
In the following we show how to reproduce the results reported in the paper. There is a Python script and the corresponding configuration file for each experiment (see below; sections correspond to the sections of the paper). Raw simulation data will be stored in the folder [results](results).
