#!/usr/bin/env python
"""Shows that catastrophic forgetting can be avoided."""
...
def main(args):
    ...
    output_directory = os.path.join("results", "rewiring_ex3", time.strftime("%y%m%d_%H%M%S"), str(trial),
                                    "data")
    ...
    utils.write_configuration(os.path.join(output_directory, "..", "config_rewiring_ex3.yaml"), config)
...
if __name__ == '__main__':
    ...
    config = utils.load_configuration("config_rewiring_ex3.yaml")
