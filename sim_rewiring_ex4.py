#!/usr/bin/env python
"""Shows that clustering breaks down at some point."""
...
def main(args):
    ...
    output_directory = os.path.join("results", "rewiring_ex4",
                                    str(input_params["num_simultaneous_assemblies"]),
                                    str(input_params["neuron_activation_probability"]),
    ...
    utils.write_configuration(os.path.join(output_directory, "..", "config_rewiring_ex4.yaml"), config)
...
if __name__ == '__main__':
    ...
    config = utils.load_configuration("config_rewiring_ex4.yaml")
