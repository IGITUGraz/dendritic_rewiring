#!/usr/bin/env python
"""Shows effectiveness of post-spike plasticity with alternative LR."""
...
def main(args):
    ...
    output_directory = os.path.join("results", "rewiring_ex7", time.strftime("%y%m%d_%H%M%S"), str(trial),
                                    "data")
    ...
    utils.write_configuration(os.path.join(output_directory, "..", "config_rewiring_ex7.yaml"), config)
...
if __name__ == '__main__':
    ...
    config = utils.load_configuration("config_rewiring_ex7.yaml")
